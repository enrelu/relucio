...
El investigador de ciberseguridad, [Jeremiah Fowler](https://twitter.com/yoda69), descubrió una **base de datos sin contraseña** con 1.500 millones de registros que contenían datos de propiedad inmobiliaria de millones de personas, entre otros nombre, domicilio y número de teléfono.
...
Investigadores de [Aqua Nautilus](https://blog.aquasec.com/the-ticking-supply-chain-attack-bomb-of-exposed-kubernetes-secrets) han descubierto **Kubernetes Secrets** -objetos que contienen pequeñas cantidades de datos sensibles, como contraseñas, tokens o claves- relacionados con cientos de organizaciones expuestas a Internet en repositorios públicos de GitHub.
